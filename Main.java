        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                if (selectedBike != null) {
                    ...
                    System.out.println("\nInvalid bike selection or car not available for rent.");
                }
            } else if (choice == 2) {
                System.out.println("\n== Return a Bike ==\n");
...
public class Main{
    public static void main(String[] args) {
        ...
        Bike bike1 = new Bike("B01", "KTM", "duke200", 1000.0); // Different base price per day for each car
        Bike bike2 = new Bike("B02", "Royal Enfield", "hunter 350", 1200.0); // Different base price per day for each car
        Bike bike3 = new Bike("B03", "Pulsur", "220", 800.0); // Different base price per day for each car
        Bike bike4 = new Bike("B04", "Triump", "Street twin", 2000.0); // Different base price per day for each car
        Bike bike5 = new Bike("B05", "Bmw", "1250 GS", 2500.0); // Different base price per day for each car
        Bike bike6 = new Bike("B06", "Kawasaki", "ninja ZX10R", 3500.0); // Different base price per day for each car
